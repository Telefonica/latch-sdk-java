...
This exception is thrown when the JDK doesn't trust the CA that signs the certificate used in https://latch.elevenpaths.com. You may need to install the CA (http://www.startssl.com/certs/ca.pem) as a trusted certificate in your JDK's truststore (normally in jre/lib/security/cacerts) using the keytool utility.
